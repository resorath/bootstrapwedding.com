      ...
      <div id="features-super-container">
        ...
        <div class="features">
          ...
          <div class="features-text" id="features-customize-left">
           ...
           <div class="btn btn-primary btn-features-cta" id="btn-features-cta-customize">Try the Editor</div>
          </div>

          <div class="features-image" id="features-customize-right">
            <div id="features-video-container">
              <div id="features-video-embed">
                <iframe width="560" height="315" src="//www.youtube.com/embed/FsjwG3FQna4" frameborder="0" allowfullscreen id="features-video-embed-content"></iframe>
              </div>
            </div>
          </div>
